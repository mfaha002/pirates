        ...
        while len(self.monsters):
            ...
            if isinstance(moving, CrewMate):
                ...
                for i in moving.items:
                    if i.damage[1] > 0 and i.verb != None and i.skill in moving.skills.keys() and (
                            i.firearm == False or i.charge == True):
...
class Itachi(Monster):
    def __init__(self, name):
        attacks = {}
        attacks["Amaterasu"] = ["burns", random.randrange(70, 101), (10, 20)]
        attacks["Totsuka Blade"] = ["slices", random.randrange(71,100), (10,20)]
        # 7 to 19 hp, bite attack, 160 to 200 speed (100 is "normal")
...
class Nagato(Monster):
    def __init__(self, name):
        attacks = {}
        attacks["Almighty Push"] = ["pushes", random.randrange(70, 80), (20, 25)]
        attacks["Universal Pull"] = ["pulls", random.randrange(90, 100), (15, 20)]
        # 7 to 19 hp, bite attack, 160 to 200 speed (100 is "normal")
...
class Tobi(Monster):
    def __init__(self, name):
        attacks = {}
        attacks["Bomb"] = ["explodes", random.randrange(60, 90), (10, 14)]
        attacks["Idiot"] = ["stupefies", random.randrange(60,80), (10,16)]
        # 7 to 19 hp, bite attack, 160 to 200 speed (100 is "normal")
        super().__init__(name, random.randrange(100, 150), attacks, 180 + random.randrange(-20, 21))
